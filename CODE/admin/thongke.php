...
$result = mysqli_query($conn, "SELECT MONTHNAME(ngay_tao) AS CREATED, sum(sl) AS SUM FROM `chitiet` INNER JOIN donhang ON donhang.id_dh = chitiet.id_dh GROUP BY MONTH(ngay_tao)");
$chart_data = '';
